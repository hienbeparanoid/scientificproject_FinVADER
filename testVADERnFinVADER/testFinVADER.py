...
data = pd.read_csv('tsla_merged.csv',index_col=None)
data['finvader'] = data['comment_text'].apply(finvader,use_sentibignomics = True, use_henry = True, indicator="compound")
print(data)